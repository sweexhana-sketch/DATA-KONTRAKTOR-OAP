 ...
 *   SMTP_PASS  = your-gmail-app-password (16 karakter)
...
export async function sendOtpEmail({ to, otp, name }) {
  if (!process.env.SMTP_USER || !process.env.SMTP_PASS) {
    console.warn('[mailer] SMTP_USER/SMTP_PASS belum dikonfigurasi — OTP tidak dikirim.');
    console.log(`[mailer] OTP untuk ${to}: ${otp}`); // dev fallback
    return;
  }
